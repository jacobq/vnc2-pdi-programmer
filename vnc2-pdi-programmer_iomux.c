...
void iomux_setup(void)
{
	...
	if (packageType == VINCULUM_II_48_PIN)
	{
		...
		// SPI_Slave_0_MISO to pin 24 as Output.
		vos_iomux_define_output(24, IOMUX_OUT_SPI_SLAVE_0_MISO);
	...
	if (packageType == VINCULUM_II_64_PIN)
	{
		...
		// SPI_Slave_0_CS to pin 33 as Input.
		vos_iomux_define_input(33, IOMUX_IN_SPI_SLAVE_0_CS);
